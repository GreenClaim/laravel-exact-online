...
namespace Yource\LaravelExactOnline\Providers;

use Illuminate\Support\ServiceProvider;
use Yource\LaravelExactOnline\LaravelExactOnline;
...
class LaravelExactOnlineServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('Exact\Connection', function () {
            ...
            $connection->setTokenUpdateCallback('\Yource\LaravelExactOnline\LaravelExactOnline::tokenUpdateCallback');
